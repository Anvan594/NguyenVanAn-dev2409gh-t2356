$(document).ready(function(){          
    ...
    if(!localStorage.getItem('students')){
        const initlalStudents=[
            { studentId: "SV0001", studentName: "Nguyễn Văn A", age: 20, sex: true, birthDate: "2002-04-23", birthPlace: "Hb", address: "25, Vũ Ngọc Phan" },
        ...
        localStorage.setItem('students',JSON.stringify(initlalStudents));
    }
    ...
    $('#search').submit(function(e){
        ...
        const sortOption =$('#sortSelrct').val();
        ...
        if(sortOption==='nameAsc'){
            ...
            students.sort((b,a)=>a.studentName.localStorage(b.studentName));
        }
